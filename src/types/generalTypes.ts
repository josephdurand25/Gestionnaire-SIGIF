...
// ==========================================
// RÉEXPORT DES TYPES SERVEUR
// ==========================================

// Étudiants
export type {
  IEtudiant,
  IEtudiantFormRequest,
  IEtudiantUpdateRequest,
  IEtudiantFilters,
  IEtudiantSearchCriteria,
  IEtudiantStatistics,
  IEtudiantListItem,
  IEtudiantCours,
  IEtudiantNote,
  ...
  Genre,
  RoleUtilisateur,
} from '../../server/src/types/Istudents_v2';
...
export type {
  ...
  TypeEvaluation,
  SessionExamen,
} from '../../server/src/types/INote_v2';

export {
  calculerNoteFinal,
  obtenirMention,
  calculerMoyenneGenerale,
  calculerCreditsObtenus,
  validerNote,
  TYPES_EVALUATION,
  SESSIONS_EXAMEN,
  MENTIONS,
...
export type {
  ...
  JourSemaine,
  Semestre,
} from '../../server/src/types/ICours_v2';
...
export type {
  ...
  IEquipements,
  TypeSalle,
} from '../../server/src/types/IFiliereEtSalle';

export {
  hasEquipement,
  getNombreOrdinateurs,
  isAdapteeFor,
  getTypeSalleLabel,
  genererCodeSalle,
  parseEquipements,
...
export type {
  IInscriptionGroupe,
  IInscriptionGroupeCreate,
  IInscriptionGroupeUpdate,
  IInscriptionGroupeFilters,
  IInscriptionGroupeWithDetails,
  IPaiementDroits,
  IPaiementDroitsCreate,
  IPaiementDroitsUpdate,
  IInscriptionBatch,
  ICapaciteCheck,
  IPrerequisCheck,
  IConflitHoraire as IConflitHoraireInscription,
  IFicheInscription,
  StatutInscription,
  StatutPaiement,
  ModePaiement,
} from '../../server/src/types/IInscription_v2';

export {
  genererNumeroInscription,
  calculerMontantRestant,
  calculerPourcentagePaye,
