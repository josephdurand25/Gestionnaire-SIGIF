        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full ">
              <Avatar src={data.user[0]?.profileImage} alt={data.user[0]?.name} size="w-12 h-12" />
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 daborder-gray-700 bg-gray-800 dark:hover:text-gray-200"
              >
                <svg
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 lg:p-11">
          ...
          <form className="flex flex-col">
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              <Button type="button" variant='perso' supStyle="bg-gray-200 hover:bg-gray-300 text-gray-800" action={closeModal}>
                Close
              </Button>
              <Button type="button" variant='perso' supStyle="bg-blue-600 hover:bg-blue-700 text-white" action={handleSave}>
                Save Changes
              </Button>
            </div>
          </form>
