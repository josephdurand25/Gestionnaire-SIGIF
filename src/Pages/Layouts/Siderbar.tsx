...
interface SidebarProps {
  ...
  toggleSidebarExpanded: (open: boolean) => void;
  menuData : any;
  variant?: 'default' | 'v2' | 'v1';
}
const Sidebar: React.FC<SidebarProps> = ({ sidebarExpanded, toggleSidebarExpanded, menuData, variant = 'default' }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar pour mobile */}
          ...
          <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl transform transition-transform duration-300 ease-in-out">
            <div className="flex min-h-0 flex-1 flex-col">
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
                ...
                <Button action={() => toggleSidebarExpanded(false)} variant='perso' icon='ri-close-line text-xl' supStyle="text-gray-500 hover:text-gray-700" />
              </div>
        ...
        <div className={`${sidebarExpanded ? 'hidden lg:flex' : 'hidden lg:flex lg:w-28'} lg:fixed lg:inset-y-0 lg:flex-col`}>
